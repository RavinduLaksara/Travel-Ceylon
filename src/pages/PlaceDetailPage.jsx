  ...
  return (
    <div className="detail-page">
      ...
      <section className="detail-hero">
        {place.image ? (
          ...
          <div className="detail-hero-placeholder">
            <svg width="64" height="64" viewBox="0 0 24 24" fill="rgba(255,255,255,0.4)">
      ...
      <section className="detail-body">
        ...
        {/* Distance Display */}
        <div className="detail-section animate-fade-in-up" style={{ animationDelay: '100ms' }}>
          <DistanceDisplay targetLat={place.lat} targetLon={place.lon} />
        </div>

        {/* Description */}
        <div className="detail-section animate-fade-in-up" style={{ animationDelay: '150ms' }}>
        ...
        {/* Weather Widget */}
        <div className="detail-section animate-fade-in-up" style={{ animationDelay: '200ms' }}>
          <WeatherWidget lat={place.lat} lon={place.lon} />
        </div>

        {/* Map Actions */}
        <div className="detail-section detail-actions animate-fade-in-up" style={{ animationDelay: '250ms' }}>
          <a
            href={googleMapsUrl}
            target="_blank"
        ...
        {/* Favorite Toggle */}
        <div className="detail-section animate-fade-in-up" style={{ animationDelay: '300ms' }}>
          <button
